...
in_channels=()
#Give client names to only upgrade on
in_clients=()
...
#IMPORTANT: fill in the total amount of channels (e.g. 5.1 = 6, 7.1.2 = 10, etc.)
ex_channels=()
#Give client names to not upgrade on (e.g. dont upgrade if the stream is on the "Bedroom Shield" -> "Bedroom Shield")
ex_clients=()
