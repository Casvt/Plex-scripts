...
Setup:
	Fill the variables below:
		...
		Example:
			...
			add to id of the series below in the list, which will enable the script to always monitor it for on-deck episodes
...
for playlist in playlists:
	...
	ssn.post(f'{base_url}/playlists', params={
		'type': 'video',
		'title': playlist_name,
		'smart': '0',
		'uri': f'server://{machine_id}/com.plexapp.plugins.library/library/metadata/{",".join(ondeck_ids)}'
	})
